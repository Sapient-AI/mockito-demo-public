...
class UserServiceSapientGeneratedTest {
    ...
    //Sapient generated method id: ${isValidUserWhenUserNotIsEnabled}, hash: E16AA5E7CC9524873866EDC498B113AA
    @Test()
    ...
    //Sapient generated method id: ${isValidUserWhenEncodedPasswordEqualsUserGetPasswordHash}, hash: EF5ACFD03A93F3E435040B41959AD3B2
    @Test()
    void isValidUserWhenEncodedPasswordEqualsUserGetPasswordHash() {
        ...
        doReturn(user).when(userRepositoryMock).findById("userId1");
        doReturn("A").when(passwordEncoderMock).encode("password1");
    ...
    //Sapient generated method id: ${isValidUserWhenEncodedPasswordNotEqualsUserGetPasswordHash}, hash: A9875CBEEBC17020BB6F6C99FB470A97
    @Test()
    ...
    //Sapient generated method id: ${findAllIdsTest}, hash: FF116FB4A4FA442A8ECE548811BEF40F
    @Test()
    void findAllIdsTest() {
        //Arrange Statement(s)
        UserService target = new UserService(userRepositoryMock, passwordEncoderMock);
        ...
        List<String> stringResultList = new ArrayList<>(List.of("id1"));
